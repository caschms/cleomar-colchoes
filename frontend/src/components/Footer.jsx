          ...
          <div className="space-y-6">
            <div className="flex items-center">
              <div className="bg-blue-600 text-yellow-400 px-4 py-2 rounded-lg font-bold text-xl">
                C CLEOMAR
                <div className="text-sm font-semibold border-t border-yellow-400 pt-1">COLCHÕES</div>
              </div>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Há mais de 40 anos oferecendo qualidade e conforto para o seu sono. Tradição e inovação em cada produto.
            </p>
            <Button
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => handleContactClick("Telefone")} className="text-gray-300 hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => handleContactClick("Email")} className="text-gray-300 hover:text-white transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm text-center md:text-left">
            © 2024 Cleomar Colchões. Todos os direitos reservados. Desde 1982 levando qualidade para um sono perfeito.
          </p>
          <p className="text-gray-500 text-xs text-center md:text-right">Desenvolvido com ❤️ para melhor atender você</p>
        </div>
      </div>
    </footer>
  );
